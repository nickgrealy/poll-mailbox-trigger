...
#    Then the response should be OK with message 'Connected to mailbox. <br>Searching folder...<br>Found matching email(s) : 1'
    ...
    Then a Jenkins job is scheduled with quietPeriod 0 and cause '[PollMailboxTrigger] Job was triggered by email sent from nickgrealy@gmail.com (<a href="triggerCauseAction">log</a>)'
